...
if(isset($_POST['submit']))
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "../admin/cars/".basename($fnew);
					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "update brands set rs_id='$_POST[res_name]',title='$_POST[d_name]',slogan='$_POST[about]',price='$_POST[price]',img='$fnew' where d_id='$_GET[menu_upd]'";
												mysqli_query($db, $sql); 
												move_uploaded_file($temp, $store);
			  
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Uspešno</strong> ažuriranje.
															</div>';
...
<head>
    ...
    <title>Moderator Izmena Automobila</title>
        ...
        <div class="page-wrapper" style="height:1200px;">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Izmena Automobila</h3> </div>
            </div>
            <!-- Container Fluid  -->
                ...
                <?php  echo $error;
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header" style="background: rgb(63, 41, 125);">
                                <h4 class="m-b-0 text-white">Izmenite Automobil</h4>
                            </div>
                            <div class="card-body">
                                <form action='' method='post'  enctype="multipart/form-data">
                                    <div class="form-body">
                                        <?php $qml ="select * from brands where d_id='$_GET[menu_upd]'";
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="d_name" value="<?php echo $roww['title'];?>" class="form-control" placeholder="Unesite Naziv">
                                                   </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="about" value="<?php echo $roww['slogan'];?>" class="form-control form-control-danger" placeholder="Unesite Karakteristike">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="price" value="<?php echo $roww['price'];?>"  class="form-control" placeholder="Unesite Cenu (Valuta Evro)">
                                                   </div>
                                            </div>
