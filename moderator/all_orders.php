...
<head>
    ...
    <title>Moderator Narudžbenice</title>
																		   ...
																		   <?php 
																			...
																			?>
																						<?php																									
																							...
																							?>
																									 <td>
																									 <a href="delete_orders.php?order_del=<?php echo $rows['o_id'];?>" onclick="return confirm('Da li ste sigurni?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																								<?php
