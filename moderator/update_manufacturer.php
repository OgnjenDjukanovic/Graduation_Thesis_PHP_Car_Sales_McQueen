...
if(isset($_POST['submit'] ))
{
	...
	mysqli_query($db, $mql);
			$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Uspešno!</strong> ažurirano.</br></div>';
...
<head>
    ...
    <title>Moderator Izmena Proizvođača</title>
        ...
        <div class="page-wrapper" style="height:1200px;">
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Izmena Proizvođača</h3> </div>
            </div>
            <!-- Container Fluid  -->
					  ...
					  <div class="row">
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header" style="background: rgb(63, 41, 125);">
                                <h4 class="m-b-0 text-white">Izmenite Proizvođača</h4>
                            </div>
                            <div class="card-body">
